...
<div class="col-md-12">
	<section class="tile color transparent-black">
		...
		<div class="tile-header">
							<h1 style="margin-left: auto; margin-right: auto; background-color:#00ffad9c;" <strong>Demande d'Autorisation de Dépense </strong>  <span style="width:10%;">AI</span></h1>
							<div class="controls">
...
<form class="ScrollStyle  form-horizontal " role="form" action="Menu_demandeur/V_connection.php" method="POST" enctype="multipart/form-data">
			...
			<!--<form class="ScrollStyle  form-horizontal " role="form" action="Menu_demandeur/V_insertJDE.php" method="POST" enctype="multipart/form-data">-->
			  ...
			  <div class="col-md-6">  
					  ...
					  <div class="select-boxes">
							...
							<div class="form-group">
									<label for="input01" class="col-sm-4 control-label">Magasin</label>
								<div class="col-sm-8">
							   ...
							   <div class="form-group">
								...
								<div class="row">
										<div class="list-group" style="margin-left:50px;">
										  <a href="#" style="text-align: center; width:97%; " class="list-group-item active">
														Selectionner Parcours d'approbation
										  </a>
										</div>
									<div class="col-md-6">
										<div class="form-group">
 ...
 <?php
	/*for($i = 1; $i <= 10; $i++) { 
       $formattedNumber = sprintf('%01d', $i) . "000"; 
...
<div class='tableFixHead'>				
 ...
 <div align="right">
     <button type="button" name="add2" id="add2" style="margin:10px;padding:10px;" class="btn btn-success btn-md">Ajouter une Ligne</button>
    </div>
    <table class="table table-bordered" id="crud_table" >
     <tr>
      <th width="10%">N° ligne</th>
      <th width="10%">Reference_demande</th>
      <th width="10%">Prix</th>
      <th width="10%">Quantité</th>
      <th width="30%">Description 1</th>
      <th width="25%">Description 2</th>
      <th width="5%"></th>
     </tr>
     <tr>

      <td contenteditable="false" class="item_ligne">1000</td>
     <td disabled="disabled" contenteditable="false" class="item_Reference_demande"><?=$empid ?></td>
      <td contenteditable="true" class="item_prix">1</td>
      <td contenteditable="true" class="item_qte">1</td>
      <td contenteditable="true" id="dd" class="item_desc1"></td>
      <td contenteditable="true" id="dd" class="item_desc2"></td>
      <td></td>
     </tr>
    </table>
  <!--  <div align="right">
     <button type="button" name="add2" id="add2" class="btn btn-success btn-md">+</button>
    </div>-->
 
  </div>
 <!-- <div align="center">
     <button type="button" name="save" id="save" class="btn btn-info">Inserer LIGNE AI</button>
    </div>-->
    <br />
</div>
...
<script>  
		...
		$('#Magcc').on('click',()=>{
			alert('clicked')
			$('#Magcc_chosen > div > div > input[type=text]').change(
							()=>{
								console.log('changed');
...
/************************************* // ligne AI //*************************************/
 ...
 $('#add2').click(function(){
  ...
  var html_code = "<tr id='row"+count+"'>";
   html_code += "<td readonly contenteditable='true' class='item_ligne' readonly>"+count+"</td>";
   html_code += "<td readonly contenteditable='true' class='item_Reference_demande' readonly><?=$empid ?></td>";
   html_code += "<td contenteditable='true' class='item_prix'>1</td>";
   html_code += "<td contenteditable='true' class='item_qte' >1</td>";
 ...
 $('#save').click(function(){
  ...
  $.ajax({
   url:"../Gestion/Menu_demandeur/V_connection.php",
   method:"POST",
   data:{item_ligne:item_ligne, item_Reference_demande:item_Reference_demande, item_prix:item_prix, item_qte:item_qte, item_desc1:item_desc1, item_desc2:item_desc2},
   success:function(data){
    alert(data);
