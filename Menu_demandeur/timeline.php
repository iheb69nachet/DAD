...
$query = "SELECT * FROM demande WHERE site='" . $_SESSION['site'] . "' AND Matricule = '" . $_SESSION['Matricule'] . "' ";
							  ...
							  <div class="tile-body color greensea rounded-corners">
								...
								<div class="table-responsive">
									<table class="table table-datatable table-custom" id="advancedDataTable">
										...
										<thead>
														<tr>
															<th width="auto">ligne</th>  
															<th width="auto">Reference_demande</th>  
															<th width="auto">Prix</th>  
															<th width="auto">Quantité</th>  
															<th width="auto">Description 1</th>  
															<th width="auto">Description 2</th>  
...
xmlhttp.onreadystatechange = function() {
  if (this.readyState == 4 && this.status == 200) {
	...
	var donnee_ligne = myObj[0].ligne;
	...
	donnee_ligne.forEach(ligne=>{
		if(ligne.id==null){
			
		}else{
			$('#ligne').append(`
<tr>
															<td>${ligne.item_ligne}</td>
															<td>${ligne.item_Reference_demande}</td>
															<td>${ligne.item_prix}</td>
															<td>${ligne.item_qte}</td>
															<td>${ligne.item_desc1}</td>
															<td>${ligne.item_desc2}</td>
