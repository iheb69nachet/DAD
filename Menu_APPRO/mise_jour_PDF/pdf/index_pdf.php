...
// Cell
$pdf->Cell(50, 10, "Type Utilisateur", 1, 0, "L", true);
$pdf->Cell(50, 10, "Nom & Prenom", 1, 0, "L", true);
$pdf->Cell(20, 10, "Matricule", 1, 0, "L", true);
$pdf->Cell(30, 10, "Statut", 1, 0, "L", true);
$pdf->Cell(40, 10, "Date Approbation ", 1, 0, "L", true);
...
////////////////////////////////////////////////////////
$pdf->SetFont("Arial", "", 12);
		$pdf->Cell(50, 15, "DEMANDEUR", 1, 0, "L", true);
		$pdf->Cell(50, 15, $row->Nom, 1);
		$pdf->Cell(20, 15, $row->Matricule, 1);
		$pdf->SetFont("Arial", "B", 10);
		$pdf->SetFillColor(54, 255, 51);
		
		if($row->Reference_demande =! ''){
			$pdf->SetFillColor(54, 255, 51);
			$pdf->Cell(30, 15, utf8_decode("Validé"), 1, 0, "C", true);
		}else{
			$pdf->SetFillColor(255, 35, 35);
			$pdf->Cell(30, 15, "----", 1, 0, "C", true);
		}
		$pdf->Cell(40, 15, $row->da, 1);
		$pdf->Ln();
////////////////////////////////////////////////////////		
$pdf->SetFillColor(209, 207, 207);
		$pdf->SetFont("Arial", "", 12);
		$pdf->Cell(50, 15, "CHEF HIERARCHIE", 1, 0, "L", true);
		$pdf->Cell(50, 15, $row->Nom_chefhierarchie, 1);
		$pdf->Cell(20, 15, $row->Matricule_chefhierarchie, 1);
		$pdf->SetFont("Arial", "B", 10);
		$pdf->SetFillColor(54, 255, 51);
...
$pdf->SetFillColor(209, 207, 207);
		$pdf->SetFont("Arial", "", 12);
		$pdf->Cell(50, 15, "COMPTABILITE", 1, 0, "L", true);
		$pdf->Cell(50, 15, $row->Nom_compt, 1);
		$pdf->Cell(20, 15, $row->Matricule_compt, 1);
		$pdf->SetFont("Arial", "B", 10);
...
$pdf->SetFillColor(209, 207, 207);
		$pdf->SetFont("Arial", "", 12);
		$pdf->Cell(50, 15, "CONTROLE GESTION", 1, 0, "L", true);
		$pdf->Cell(50, 15, $row->Nom_cges, 1);
		$pdf->Cell(20, 15, $row->Matricule_cges, 1);
		$pdf->SetFont("Arial", "B", 10);
		$pdf->SetFillColor(54, 255, 51);
...
$pdf->SetFillColor(209, 207, 207);
		$pdf->SetFont("Arial", "", 12);
		$pdf->Cell(50, 15, "DGA", 1, 0, "L", true);
		$pdf->Cell(50, 15, $row->Nom_dg, 1);
		$pdf->Cell(20, 15, $row->Matricule_dg, 1);
		$pdf->SetFont("Arial", "B", 10);
		$pdf->SetFillColor(54, 255, 51);
...
$pdf->Ln();
$pdf->SetFont("Arial", "B", 12);
$pdf->Cell(40, 15, utf8_decode("Budget Alloué  :"), 0, "C", true);
$pdf->SetFont("Arial", "", 12);
$pdf->Cell(40, 15, $row->Budget_allouer);
$pdf->SetFont("Arial", "B", 12);
$pdf->Cell(43, 15, utf8_decode("Budget Restant :"), 0, "C", true);
$pdf->SetFont("Arial", "", 12);
...
$pdf->Cell(40, 10, "Description 1", 1, 0, "L", true);
$pdf->Cell(40, 10, "Description 2", 1, 0, "L", true);
...
while ($k = mysqli_fetch_object($ligne))
{
	...
	$pdf->Cell(40, 10, utf8_decode($k->item_desc1), 1);
	$pdf->Cell(40, 10, utf8_decode($k->item_desc2), 1);
	$pdf->Ln();
$pdf->SetFillColor(209, 207, 207);
$pdf->SetY(260);
	$pdf->SetFont("Arial", "B", 12);
