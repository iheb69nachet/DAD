...
$connect = mysqli_connect("localhost", "root", "", "projetphase1");
 ...
 $query = "SELECT * FROM demande WHERE etat_verife_cg='Valider' AND avis_DGA='Valider' AND site='".$_SESSION['site']."' ORDER BY id DESC";  
$result = mysqli_query($connect, $query);

$query2 =  "SELECT * FROM demande WHERE etat_verife_cg='Valider' AND avis_DGA='Valider' AND site='".$_SESSION['site']."' ORDER BY id DESC";  
...
<body>
     ...
     <section class="tile transparent ">
          <div class="tile-header transparent">
               <h1><strong>Listes Des Demandes  </strong> En Attente de Génaration </h1>
          ...
          <div class="tile-body color transparent-black rounded-corners">
               ...
               <div class="table-responsive" style="width:100%; height:250px; overflow:auto;">
                    <table class="table table-datatable table-custom" id="advancedDataTable">
                     ...
                     <td>
                              <a class='btn btn-warning btn-md' href="Menu_APPRO/mise_jour_PDF/pdf/index_pdf.php?id=<?php echo $row["id"]; ?>">PDF</a>
                       </td>
