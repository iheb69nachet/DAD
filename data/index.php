...
if(isset($_GET['id'])){
$id=$_GET['id'];
    $sql='select * from demande where Reference_demande='.$id."and site='" . $_SESSION['site'] . "' AND Matricule = '" . $_SESSION['Matricule'] . "' ";


}
elseif(isset($_GET['etat'])){
    $etat=$_GET['etat'];
    //site='" . $_SESSION['site'] . "' AND Matricule = '" . $_SESSION['Matricule'] . "' "
    $sql='select * from demande where Etat ="'.$etat.'" and avis_DGA ="Valider" and '."site='" . $_SESSION['site'] . "' AND Matricule = '" . $_SESSION['Matricule'] . "' ";


}else{
    $sql='select * from demande where Etat !="Valider" and Etat !="en attente" and '."site='" . $_SESSION['site'] . "' AND Matricule = '" . $_SESSION['Matricule'] . "' ";
