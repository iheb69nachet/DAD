                ...
                <div class="modal-body">  
                     <form method="post" id="insert_form">  
								...
								<div class="col-sm-8" id="selectbox" >
								  <select name="validation_sst" class="chosen-select chosen-transparent form-control"  id="input07" parsley-trigger="change" parsley-required="true" parsley-error-container="#selectbox">
									<option value=""></option>
