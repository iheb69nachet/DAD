          ...
          <div class="navbar-collapse" >
            ...
            $(document).ready(function() {
				 $('#Formulaire_Votage').on('click',function()  {
                    $('#target').load('Menu_Comptabilite/suivi.php');
                }); 
				$('#suivi_demande').on('click',function()  {
                    $('#target').load('../Gestion/Menu_Comptabilite/mise_jour_demande/index.php');
                });
              ...
              <li class="navigation" id="navigation">
                ...
                <ul class="menu">
                    ...
                    <a href="#" id="suivi_demande">
                      <i class="fa fa-pencil"></i> Validation Type Dépense
                    </a>
                  </li>
